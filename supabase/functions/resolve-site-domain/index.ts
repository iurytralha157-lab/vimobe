...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data: directMatch, error: directError } = await supabase
      ...
      .select('organization_id, subdomain, custom_domain, site_title, site_description, primary_color, secondary_color, accent_color, logo_url, logo_width, logo_height, favicon_url, whatsapp, phone, email, address, city, state, instagram, facebook, youtube, linkedin, about_title, about_text, about_image_url, about_subtitle, about_stats, about_checkmarks, about_features, show_about_on_home, seo_title, seo_description, seo_keywords, google_analytics_id, gtm_id, meta_pixel_id, google_ads_id, head_scripts, body_scripts, hero_image_url, hero_title, hero_subtitle, page_banner_url, watermark_logo_url, watermark_opacity, watermark_enabled, site_theme, background_color, text_color, card_color, watermark_size, watermark_position, organizations(name)')

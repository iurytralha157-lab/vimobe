...
-- Update list_contacts_paginated to respect custom RBAC permissions
...
BEGIN
  ...
  IF NOT v_is_admin AND NOT v_is_super_admin THEN
    ...
    -- Check if user has lead_view_team permission
    v_can_view_team := public.user_has_permission('lead_view_team', v_user_id);
    
    -- If user can view team leads, get team member IDs

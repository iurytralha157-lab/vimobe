...
BEGIN
  ...
  LOOP
    ...
    v_next_index := COALESCE(v_queue.current_position, 0);
    ...
    -- Update position for next lead
    UPDATE round_robins 
    SET current_position = (v_next_index + 1) % v_member_count

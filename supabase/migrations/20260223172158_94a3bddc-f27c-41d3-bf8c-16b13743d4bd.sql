...
-- Add new theme columns to organization_sites
ALTER TABLE public.organization_sites 
  ADD COLUMN IF NOT EXISTS site_theme text NOT NULL DEFAULT 'dark',
  ADD COLUMN IF NOT EXISTS background_color text NOT NULL DEFAULT '#0D0D0D',
  ADD COLUMN IF NOT EXISTS text_color text NOT NULL DEFAULT '#FFFFFF';

-- Update resolve_site_domain function to include new fields

-- Fix list_contacts_paginated to support super_admin users who may have NULL organization_id
-- Super admins should be able to see all leads across all organizations
...
BEGIN
  ...
  -- Return paginated results with role-based visibility (simplified - removed DISTINCT ON for better performance)
  RETURN QUERY
  SELECT
    l.id,
    l.name,

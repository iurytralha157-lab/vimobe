-- Fix handle_lead_intake function - correct column names for activities table
...
BEGIN
  ...
  IF v_assigned_user_id IS NOT NULL THEN
    ...
    -- Create activity - FIXED: use correct column names (user_id, content instead of created_by, description)

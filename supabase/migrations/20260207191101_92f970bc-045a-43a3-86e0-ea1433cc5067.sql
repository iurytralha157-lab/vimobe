-- Corrige a função list_contacts_paginated removendo colunas inexistentes
-- A tabela leads NÃO tem: sla_status, last_interaction_at, last_interaction_preview, last_interaction_channel
...
BEGIN
  ...
  -- Return data - usando NULL para colunas que não existem na tabela leads
  RETURN QUERY
  SELECT 
    l.id,
    l.name,

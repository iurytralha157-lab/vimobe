            ...
            if (platform === 'meta' || platform === 'facebook' || source === 'meta' || source === 'facebook') {
              ...
              return (
                <div className="flex items-center gap-1.5 -mt-1 mb-1 min-w-0">
                  <svg className="h-3 w-3 shrink-0" viewBox="0 0 80 80" fill="none">
                    <linearGradient id="meta-g" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="#0668E1"/>
                      <stop offset="50%" stopColor="#0080FB"/>
                      <stop offset="100%" stopColor="#0099FF"/>
                    </linearGradient>
                    <path d="M16 40c0-8.2 3-14.8 6.8-18.6C26 18.2 29.6 16.8 33 18c4 1.4 7.4 7 10.4 13.6l1.2 2.6c2.6 5.8 5 10.8 8.2 13.4 2.2 1.8 4.6 2.6 7.2 1.8 3.4-1.2 6-5.4 7.4-10.4.8-3 1.2-6.2 1.2-9 0-8.2-3-14.8-6.8-18.6C58.6 8 54 7 50.8 8.4c-2.8 1.2-5.4 4.6-7.8 9.2-.6 1.2-1.2 2.4-1.8 3.8l-.6 1.2c-.6-1.4-1.2-2.6-1.8-3.8-2.4-4.8-5.2-8.4-8.2-9.6C27.2 7.6 22.8 8.8 19.4 12 14.6 16.4 11.2 24.6 11.2 34c0 12.6 5.6 22.4 12.4 27.2 3.4 2.4 7 3.6 10.4 3.6v-5.4c-2.4 0-4.8-.8-7.2-2.6C21.2 53 16 45.2 16 40zm36.8-14.4c2.4-4.6 5-7.6 7.4-8.6 2-.8 4.4 0 6.6 2.2C70 22.4 73.2 29 73.2 37c0 3-.4 6-1.2 8.6-1.2 4.2-3.4 7.4-5.8 8.2-1.6.6-3.2 0-4.8-1.2-2.6-2.2-4.8-6.4-7.2-11.8l-1.2-2.8c-1-2.2-2-4.4-3-6.2.4-.8.6-1.6 1-2.4l.8-1.4z" fill="url(#meta-g)"/>
                  </svg>

...
export default function PublicSiteLayout() {
  ...
  useEffect(() => {
    ...
    const gtmId = (siteConfig as any).gtm_id;
    if (gtmId) {
    ...
    const pixelId = (siteConfig as any).meta_pixel_id;
    if (pixelId) {
    ...
    const gadsId = (siteConfig as any).google_ads_id;
    if (gadsId) {
    ...
    const headScripts = (siteConfig as any).head_scripts;
    if (headScripts) injectScript(headScripts, 'head');

    const bodyScripts = (siteConfig as any).body_scripts;

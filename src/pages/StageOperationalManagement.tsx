...
export default function StageOperationalManagement() {
  ...
  return (
    <AppLayout title="Configuração de Gatilhos Operacionais">
...
// Hook auxiliar para buscar estágios do pipeline (baseado no useStages mas focado no mapeamento)
